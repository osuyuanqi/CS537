...
# #             nn.Conv2d(64, 64, kernel_size=4, bias = False),
# #             nn.BatchNorm2d(64, affine=False),
# #             nn.ReLU(),
            
#             nn.Conv2d(64, 96, kernel_size=3, stride=2, padding=2, bias = False),
#             nn.BatchNorm2d(96, affine=False),
#             nn.ReLU(),
            
#             nn.Conv2d(96, 128, kernel_size=4, stride=2, padding=6, bias = False),
#             nn.BatchNorm2d(128, affine=False),
#             nn.ReLU(),
            #mine end
            #another edi
